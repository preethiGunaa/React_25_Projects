                        ...
                        </div>
                        {
                            enableMultiSelection ? multiple.indexOf(dataItem.id) !== -1 &&
                                <div className="dataItem">
                                    <ul>
                                        <li>Instructor:{dataItem.instructor}</li>
                                        <li>Level: {dataItem.level}</li>
                                        <li>Students:Enrolled{dataItem.studentsEnrolled}</li>
                                        <li>Ratings:{dataItem.rating}</li>
                                    </ul>

                                </div> : selected === dataItem.id && <div className="dataItem">
                                    <ul>
                                        <li>Instructor:{dataItem.instructor}</li>
                                        <li>Level: {dataItem.level}</li>
                                        <li>Students:Enrolled{dataItem.studentsEnrolled}</li>
